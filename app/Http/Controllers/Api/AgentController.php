...
class AgentController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => $result->map(fn($a) => $this->formatAgent($a, $locale)),
            'meta' => [
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json(['data' => $this->formatAgent($agent, $locale), 'error' => false, 'message' => null]);
    }
    ...
    private function formatAgent(Agent $agent, string $locale = 'fr'): array
    {
        $raw       = $agent->avatar_id;
        $avatarUrl = $raw
        ...
        return $this->overlayTranslations($data, 'agent', $agent->id, $locale, ['description']);
    }
}
