...
const DEFAULTS = {
  site_name: 'Mahalo',
  tagline: 'La plateforme immobilière la plus fiable du Maroc',
  ...
  seo_description: 'Trouvez votre bien idéal au Maroc avec Mahalo. Des milliers d\'annonces vérifiées à Marrakech, Rabat, Tanger, Agadir et partout au Maroc.',
  google_analytics_id: '',
  currency: 'MAD',
  ...
  page_cookie: '',
  team_members: '[]',
  footer_description: 'Des expériences immobilières premium au Maroc. Découvrez votre maison de rêve grâce à notre sélection de propriétés d\'exception.',
  ...
  cookie_consent_title: 'Nous utilisons des cookies',
  cookie_consent_message: 'Nous utilisons des cookies pour améliorer votre expérience, analyser le trafic et personnaliser le contenu. Vous pouvez gérer vos préférences ci-dessous.',
  cookie_accept_text: 'Tout accepter',
  cookie_decline_text: 'Refuser',
  cookie_policy_url: '/privacy',
  groq_api_key: '',
  ai_model: 'llama-3.3-70b-versatile',
  mobile_app_enabled: '1',
  mobile_app_title: 'Votre prochaine maison',
  mobile_app_subtitle: 'est entre vos mains',
