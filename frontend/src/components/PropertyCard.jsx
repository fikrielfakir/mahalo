      ...
      {total > 1 && (
        <>
          <button
            ...
            className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 touch-device-show transition-opacity duration-200 z-10"
          ...
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 touch-device-show transition-opacity duration-200 z-10"
            style={{ background: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(6px)' }}
          >
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {wa && (
              <button
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110 touch-manip"
            ...
            <button
              ...
              className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110 text-white touch-manip"
              style={{ background: 'linear-gradient(135deg, #730D26, #BA1932)' }}
              title="Contact agent"
            >
