  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-card p-8">
        <h1 className="text-2xl font-bold text-navy mb-1">{t('auth.welcomeBack')}</h1>
        <p className="text-navy/50 text-sm mb-7">{t('auth.signInToAccount')}</p>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white px-3 text-xs text-navy/40 font-medium">{t('auth.orContinueWithLogin')}</span>
          </div>
        </div>
        ...
        >
          ...
          {googleLoading ? t('auth.redirecting') : t('auth.signInWithGoogle')}
        </button>
