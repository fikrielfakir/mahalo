...
<html {!! Theme::htmlAttributes() !!}>
    <head>
        ...
        <style>
            @font-face {
                font-family: 'icomoon';
                src: url('{{ Theme::asset()->url('fonts/icomoon.woff2') }}') format('woff2'),
                     url('{{ Theme::asset()->url('fonts/icomoon.woff') }}') format('woff'),
                     url('{{ Theme::asset()->url('fonts/icomoon.ttf') }}') format('truetype');
                font-weight: normal;
                font-style: normal;
                font-display: block;
            }
